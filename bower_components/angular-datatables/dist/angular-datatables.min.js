...
"undefined" != typeof module &&
	...
	(function (a, b, c, d) {
			...
			function g(a) {
				...
				return function (a, c, f, g) {
					...
					d.forEach(
						...
						e.showLoading(c, a),
						g.render(c, g.buildOptionsPromise(), b);
				};
			}
			function h(g) {
				function h() {
					...
					return (
						a
							.all([
								a.when(g.dtOptions),
								a.when(g.dtColumns),
								a.when(g.dtColumnDefs),
							])
							.then(function (c) {
								var e = c[0],
									g = c[1],
									h = c[2];
								f.deleteProperty(e, "$promise"),
									f.deleteProperty(g, "$promise"),
									f.deleteProperty(h, "$promise");
								var i;
								if (
									d.isDefined(e) &&
									((i = {}),
									d.extend(i, e),
									d.isArray(g) && (i.aoColumns = g),
									d.isArray(h) && (i.aoColumnDefs = h),
									i.language && i.language.url)
								) {
									var j = a.defer();
								...
								return f.resolveObjectPromises(i, [
									"data",
									"aaData",
									"fnPromise",
								]);
				...
				function j(a) {
					d.isFunction(g.dtInstance)
						? g.dtInstance(a)
						: d.isDefined(g.dtInstance) && (g.dtInstance = a);
				}
				var k,
					l = this;
		...
		function g() {
			...
			return {
				newColumn: function (b, c) {
					if (d.isUndefined(b))
						throw new Error(
							'The parameter "mData" is not defined!'
						);
		...
		function k() {
			c.fn.DataTable.Api &&
				c.fn.DataTable.Api.register("ngDestroy()", function (b) {
					return (
						(b = b || !1),
						this.iterator("table", function (d) {
							...
							(d.bDestroying = !0),
								c.fn.DataTable.ext.internal._fnCallbackFire(
									d,
									"aoDestroyCallback",
									"destroy",
									[d]
								...
								(d.aaSorting = []),
								(d.aaSortingFixed = []),
								c.fn.DataTable.ext.internal._fnSortingClasses(
									d
								),
								c(o).removeClass(d.asStripeClasses.join(" ")),
								c("th, td", j).removeClass(
									g.sSortable +
										" " +
										g.sSortableAsc +
										" " +
								...
								d.bJUI &&
									...
									c("th, td", j).each(function () {
										var a = c(
											"div." + g.sSortJUIWrapper,
											this
										);
										c(this).append(a.contents()),
											a.detach();
									})),
								!b &&
									f &&
									(f.contains(d.nTableReinsertBefore)
										? f.insertBefore(
												h,
												d.nTableReinsertBefore
										  )
										: f.appendChild(h)),
								l
		...
		function l() {
			...
			function e(a) {
				return (
					c.extend(!0, c.fn.DataTable.defaults, { language: a }), j
				);
			}
			function f(a) {
				return (
					c.extend(c.fn.DataTable.defaults, { displayLength: a }), j
				);
			}
			function g(a) {
			...
			function h(a) {
				return c.extend(c.fn.DataTable.defaults, { dom: a }), j;
			}
			function i(a, b) {
				if (d.isString(a)) {
					var e = {};
		...
		function o(a, b, c, d) {
			function e(e) {
				function f(b, e) {
					...
					return (
						(j = g.DataTable), d.copyDTProperties(g, f), a.when(f)
					);
				}
				function g() {}
				function h() {}
			...
			function h(h) {
								...
								o && r && m(),
									d(
										function () {
											...
											var a =
												f.hideLoadingAndRenderDataTable(
													p,
													t.options
												);
											(o = a.DataTable),
												g.copyDTProperties(a, s),
												h.resolve(s);
										},
										0,
										!1
				...
				function l() {
					m(),
						...
						d(
							function () {
								var a = f.hideLoadingAndRenderDataTable(
									p,
									t.options
								);
			...
			function h(h) {
				function i(b, c) {
					...
					return (
						...
						(r = b),
						(s = c),
						m(v.options.fnPromise, f.renderDataTable).then(
							function (a) {
								(q = a.DataTable),
									g.copyDTProperties(a, t),
									d.resolve(t);
							}
						),
						d.promise
				...
				function j(a, b) {
					...
					d.isFunction(v.options.fnPromise)
						? m(v.options.fnPromise, p).then(function (c) {
								d.isFunction(a) && a(c.DataTable.data()),
									b === !1 && c.DataTable.page(e).draw(!1);
						  })
						: c.warn(
				...
				function k(a) {
					(v.options.fnPromise = a),
						(s.dtOptions.fnPromise = a),
						m(v.options.fnPromise, p);
				}
				function l() {
				...
				function n(b, c) {
					var e = a.defer();
					return (
						(u = d.isFunction(b) ? b() : b),
						u.then(function (a) {
							var b = a;
							if (v.options.sAjaxDataProp)
								for (
									var d = v.options.sAjaxDataProp.split(".");
									d.length;
				...
				function p(a, b) {
					return (
						q.clear(),
						q.rows.add(b.aaData).draw(b.redraw),
						{
							id: t.id,
			...
			function h(h) {
				function i(b, c) {
					...
					var e = a.defer(),
						h = g.newDTInstance(r);
					return (
						d.isUndefined(r.options.sAjaxDataProp) &&
							(r.options.sAjaxDataProp = f.sAjaxDataProp),
						d.isUndefined(r.options.aoColumns) &&
							(r.options.aoColumns = f.aoColumns),
						m(r.options, b).then(function (a) {
							(o = a.DataTable),
								g.copyDTProperties(a, h),
								e.resolve(h);
						}),
						e.promise
					);
				...
				function m(c, d) {
					...
					return (
						(c.bDestroy = !0),
						o && (o.destroy(), e.showLoading(p, q), d.empty()),
						e.hideLoading(d),
						n(c)
							? b(
									function () {
				...
				function n(a) {
					return d.isDefined(a) && d.isDefined(a.dom)
						? a.dom.indexOf("S") >= 0
						: !1;
				}
				var o,
		...
		function s(a, b, c, e) {
			function f(f, g) {
				...
				if (d.isDefined(f)) {
					...
					return (d.isDefined(f.ajax) && null !== f.ajax) ||
						(d.isDefined(f.ajax) && null !== f.ajax)
						? e.create(f)
						: a.create(f);
				}
				return a.create();
		...
		function t(a) {
			function b(a, c) {
				var e = d.copy(a);
				if (
					((d.isUndefined(e) || null === e) && (e = {}),
					d.isUndefined(c) || null === c)
				)
					return e;
				if (d.isObject(c))
					for (var f in c)
						c.hasOwnProperty(f) && (e[f] = b(e[f], c[f]));
				else e = d.copy(c);
				return e;
			}
			function e(a, b) {
			...
			function f(b, e) {
				...
				if (!d.isObject(b) || d.isArray(b)) f.resolve(b);
					...
					for (var k in i)
						i.hasOwnProperty(k) &&
							-1 === c.inArray(k, j) &&
							h.push(d.isArray(i[k]) ? g(i[k]) : a.when(i[k]));
		...
		d
			...
			d
				...
				.factory("DTOptionsBuilder", f)
				.factory("DTColumnBuilder", g)
				.factory("DTColumnDefBuilder", h)
				.factory("DTLoadingTemplate", i),
			(h.$inject = ["DTColumnBuilder"]),
			(i.$inject = ["$compile", "DTDefaultOptions", "DT_LOADING_CLASS"]),
			d
				.module("datatables.instances", ["datatables.util"])
				.factory("DTInstanceFactory", j),
			d
				.module("datatables", [
			...
			d
				...
				.factory("DTRendererService", m)
				.factory("DTRenderer", n)
				.factory("DTDefaultRenderer", o)
				.factory("DTNGRenderer", p)
				.factory("DTPromiseRenderer", q)
				.factory("DTAjaxRenderer", r)
				.factory("DTRendererFactory", s),
			(m.$inject = ["DTLoadingTemplate"]),
			(o.$inject = [
				"$q",
				"DTRenderer",
				"DTRendererService",
			...
			d.module("datatables.util", []).factory("DTPropertyUtil", t),
			(t.$inject = ["$q"]);
